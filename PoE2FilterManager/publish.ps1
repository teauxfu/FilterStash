...
dotnet publish "..\PoE2FilterManager\PoE2FilterManager.csproj" -f net9.0-windows10.0.19041.0 -c Release --no-self-contained   -p:RuntimeIdentifierOverride=win10-x64 -p:WindowsPackageType=None
